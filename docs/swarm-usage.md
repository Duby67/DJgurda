...
7. Для approval checkpoints использовать wrappers `approve_run_checks`, `approve_run_checks_and_continue`, `approve_commit`, `reject_checkpoint` или request-команды, когда нужен полный approval packet.
