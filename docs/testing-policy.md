...
- Если orchestrator дошел до verification boundary, он должен остановить run, показать пользователю планируемые проверки и явно запросить approval перед запуском.
