...
В этой директории лежат implementation plans, которые сейчас находятся в работе.

## Current Plans

- `docs/exec-plans/active/url-extraction-and-routing-robustness.md`
  - medium-priority task по URL punctuation edge cases и bounded multi-link resolve behavior.
