...
13. В конце обработки, после завершения всех правок, предлагай наименование коммита на английском в формате готовй команды типа `git add . && git commit -a -m "Предложение коммита"` для `cmd`/PowerShell.
