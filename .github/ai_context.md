...
13. В конце обработки, после завершения всех правок, предлагай commit message на английском в формате готовой команды для cmd/PowerShell, например:git commit -a -m "docs: update release workflow and backlog sync".
