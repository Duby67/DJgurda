...
- Исключение для практической проверки handlers: используй локальные smoke-скрипты в `test/TikTok`, `test/YouTube`, `test/Instagram`.
...
- `tests/` / `test/` - legacy зона на текущем этапе; не используется как источник актуального контекста, кроме согласованных smoke-скриптов handlers в `test/TikTok`, `test/YouTube`, `test/Instagram`.
...
7. Не считай `docs/` и `tests/` актуальным источником правды, кроме согласованных smoke-скриптов проверки handlers (`test/TikTok`, `test/YouTube`, `test/Instagram`).
