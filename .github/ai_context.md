...
- `tests/` и `test/` в основном остаются legacy-зоной контекста, кроме согласованного прототипа локальной проверки handlers: `test/TikTok/test_tiktok_handlers_local.py` + `test/TikTok/TikTok_urls.py`.
...
- Исключение для практической проверки TikTok handlers: используй связку `test/TikTok/test_tiktok_handlers_local.py` + `test/TikTok/TikTok_urls.py`.
...
- `tests/` / `test/` - legacy зона на текущем этапе; не используется как источник актуального контекста, кроме согласованного прототипа проверки handlers (`test/TikTok/test_tiktok_handlers_local.py` + `test/TikTok/TikTok_urls.py`).
...
7. Не считай `docs/` и `tests/` актуальным источником правды, кроме согласованного прототипа проверки handlers (`test/TikTok/test_tiktok_handlers_local.py` + `test/TikTok/TikTok_urls.py`).
