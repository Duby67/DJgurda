...
1. Сначала читай `README.md` и `.github/ai_context.md`.
...
5. Не анализируй `venv/`, `__pycache__/` и `.env` как источник контекста проекта.
6. Не выдумывай отсутствующие фичи.
7. Если что-то непонятно - фиксируй это в разделе gaps, а не домысливай.
8. Вноси изменения минимально и локально, не ломая существующую структуру.
9. Язык комментариев и всех человеко-читаемых проектных файлов - русский.
10. Логи, технические runtime-сообщения и похожие служебные сегменты - английский.
